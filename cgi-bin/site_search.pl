...
<html>
<head>
<title>Metrication, metric conversion, and other Metrication matters: Search</title>
<meta name="Author" CONTENT="First Step Communications">
...
<form method=get action="/cgi-bin/site_search.pl">
<p><table border=0>
<tr><th align=right>Search for:</th>
...
<input type=hidden name="subsearch" value="">
</td></tr></table>
</form>
